...
<div class="personal-footer">
    <div class="personal-footer_w clearFix">
        <ul class="personal-footer-links">
            ...
            <li><a href="https://www.lexic.xyz" target="blank"><%= Resource.CorporateUse %></a></li>
        </ul>
        <div class="personal-footer_rights">
            © Ektai Solutions LTD <%= DateTime.UtcNow.Year.ToString() %>. <%= Resource.AllRightsReserved %>
            <a href="https://www.instagram.com/the_lexic/" class="personal-footer_inst"></a>
        </div>
    </div>
</div>