    ...
    this.Finish = function() {
        ...
        try {
            if (window.ga) {
                ...
                window.ga('www.send', 'event', 'lexic_adwords', 'wizard_finish');
                window.ga('testTracker.send', 'pageview', '/wizard_finish');
                window.ga('testTracker.send', 'event', 'lexic_adwords', 'wizard_finish');
            }
            window.uetq = window.uetq || [];
            window.uetq.push({ 'ec': 'lexic_msn', 'ea': 'clickto', 'el': 'onbutton', 'ev': '1' });
        } catch(err) {
        }
