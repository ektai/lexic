...
<asp:Content ID="CommonContainer" ContentPlaceHolderID="BTPageContent" runat="server">
    <div>
        ...
        <ul class="help">
            <li>
                <a href="http://helpcenter.lexic.xyz/" target="_blank" class="link underline">Help Center</a>
            </li>
            <li>
                <a href="http://cloud.lexic.org/" target="_blank" class="link underline">SaaS Forum</a>
            </li>
            <li>
                <a href="http://dev.lexic.org/" target="_blank" class="link underline">Server Forum</a>
            </li>
            <li>
                <a href="http://support.lexic.xyz/" target="_blank" class="link underline">Support Contact Form</a>
            </li>
        </ul>
    </div>
</asp:Content>
