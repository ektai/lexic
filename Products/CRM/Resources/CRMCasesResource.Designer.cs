...
namespace ASC.Web.CRM.Resources {
    ...
    public class CRMCasesResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Match your file columns with the corresponding LEXIC™ CRM fields. Please pay your attention to the fact that to import cases correctly you need to have at least one column from your file matched with the &apos;Case Title&apos; field of the LEXIC™ CRM. The fields containing the dates must have the following format: {0}..
        /// </summary>
