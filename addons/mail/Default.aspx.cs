...
namespace ASC.Web.Mail
{
    public partial class MailPage : MainPage, IStaticBundle
    {
        ...
        private const string DEFAULT_FAQ_URL = "http://helpcenter.lexic.xyz/" + MAIL_TROUBLESHOOTING;
        ...
        {
            return WebConfigurationManager.AppSettings["mail.daemon-email"] ?? "mail-daemon@lexic.xyz";
        }
